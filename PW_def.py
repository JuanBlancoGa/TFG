...
P_spec = np.array([0.0, -0.5556, 0.7025, 0.5147, -0.2778, +0.1669,0.0 ,0.0 ,+0.5022 ])
Q_spec = np.array([0.0, -0.2778, 0, 0, -0.1389, 0.0, 0.0,0.0 , 0.0])  # només per PQ
...
for iteration in range(100):
    ...
    #COMPROVAR VALORS AMB IF, SI NO JACOBIANA
